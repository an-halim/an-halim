...
export default function Footer() {
  return (
    <div className="dark:bg-slate-900">
      {/* footer */}
      <footer className='max-w-7xl mx-auto px-8 sm:px-6 md:px-8 lg:px-10 py-5'>
        <div className='lg:flex lg:justify-around sm:flex sm:justify-around text-center'>
          <div className='flex text-black font-semibold py-2 justify-center dark:text-white '>
            Powered by
          ...
          <div className='flex text-black py-2 justify-center'>
            ...
            <a href="https://github.com/an-halim" target={"_blank"} rel="noreferrer">
              <svg
                xmlns='http://www.w3.org/2000/svg'
            ...
            <a href="https://instagram.com/_anhalim" target={"_blank"} rel="noreferrer">
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='w-6 h-6 mx-2'
                preserveAspectRatio='xMidYMid meet'
